    ...
    >
      ...
      <template #cell(actions)="data">
        <div class="d-flex align-items-center">
          ...
          <UtilsTheFIcon
            v-if="deleteIcon"
            v-show="!data.item[preventDeleteIfIsConfirmed]"
            icon="trash"
...
export default {
  ...
  methods: {
    ...
    showMsgBoxToTransfer(data) {
      this.$bvModal
        .msgBoxConfirm(
          `هل أنت متأكد من ترحيل هذا العنصر ( ${data.item.name} )`,
          {
            title: 'تأكيد للحذف',
            size: 'sm',
            okVariant: 'primary',
    ...
    showMsgBoxToConfirmDelete(data) {
      this.$bvModal
        .msgBoxConfirm(
          `هل أنت متأكد من حذف رقم الطلبية ( ${data.item.orderNo} )`,
          {
            title: 'تأكيد للحذف',
            size: 'sm',
            okVariant: 'primary',
