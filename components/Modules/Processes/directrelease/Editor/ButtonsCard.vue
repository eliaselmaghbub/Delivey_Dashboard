  ...
  <b-card>
    <b-row class="justify-content-center align-items-center row-buttons">
      ...
      <b-button
        variant="primary"
        class="btn-w"
        to="/processes/direct-release/new"
        @click="reset"
      >
        جديد
      </b-button>
      ...
      <b-button
        variant="primary"
        class="btn-w"
        :disabled="loadingConfirm || fields.isConfirmed || !currentId"
        @click="confirm"
      >
        إعتماد
        <b-spinner
      ...
      <b-button
        variant="primary"
        class="btn-w"
        :disabled="loadingunconfirm || !fields.isConfirmed || !currentId"
        @click="unconfirm"
      >
        إلغاء الإعتماد
        <b-spinner
