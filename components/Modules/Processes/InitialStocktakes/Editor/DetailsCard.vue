      ...
      <b-card-body>
        <b-row>
          <FormFVSelect
            ...
            :disabled="display.index != null || display.isConfirm"
            change
            lg="4"
          />
          <FormFVSelect
            ...
            required
            :disabled="
              display.index != null || !fields.storeId || display.isConfirm
            "
            change
            lg="4"
          />
        ...
        <ModulesProcessesInitialStocktakesEditorTheTable
          :headers="headers"
          :module-name="moduleName"
        />
      </b-card-body>
